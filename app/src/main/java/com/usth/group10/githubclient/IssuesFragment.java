...
public class IssuesFragment extends Fragment {
    ...
    private static class HomeFragmentPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int page) {
            ...
            switch (page) {
                case 0: return EmptyFragment.newInstance("issues");
                case 1: return EmptyFragment.newInstance("issues");
                case 2: return EmptyFragment.newInstance("issues");
                case 3: return EmptyFragment.newInstance("issues");
